...
list_mutant_genomic <- list(
  ...
  hoxA = c(gene_list_mh, gene_list_sh),
...
```{r, echo = FALSE, results = 'hide'}
svg("../figures/figure_mutant_mu.svg", width = 7.5, height = 2.65)
print(plot_growth_dcw, position = c(0, 0, 0.5, 1), more = TRUE)
print(plot_growth_mu, position = c(0.5, 0, 1, 1), more = TRUE)
grid::grid.text(c("D","E"), x = c(0.03, 0.5), y = c(0.94, 0.94), gp = grid::gpar(cex = 1.2))
dev.off()
```
