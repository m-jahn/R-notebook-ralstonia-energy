...
print(plot_cost_vs_mu, position = c(-0.017, 0, 0.38, 0.38), more = TRUE)
print(plot_mbh_operon, position = c(0.34, 0.14, 0.97, 0.38), more = TRUE)
print(plot_sh_operon, position = c(0.34, 0, 0.63, 0.24))
grid::grid.text(c("A","B","C","D"), x = c(0.02, 0.02, 0.02, 0.36),
  y = c(0.98, 0.66, 0.34, 0.34), gp = grid::gpar(cex = 1.2))
```
