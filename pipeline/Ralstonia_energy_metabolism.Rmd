...
df_fitness_summary <- df_fitness %>%
  ...
  mutate(cond_short = paste0(substrate, " - ", cond_short) %>% factor(., unique(.)))
...
- **hydrogenase**
  ...
  - hypA1,B1,F1,C1,D1,E1 = metallocenter formation proteins for both MBH and SH
...
print(plot_moco_fit, position = c(0, 0.475, 0.5, 1), more = TRUE)
print(plot_fdh_fit, position = c(0.475, 0.49, 0.95, 1), more = TRUE)
print(plot_hyd_fit, position = c(0, 0, 0.5, 0.5))
```

### Electron transport chain

NDH, cytochrome reductases and oxygenases
